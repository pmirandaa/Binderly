# T-BE-API-CLIENT — Typed API client used by web and mobile
...
> 8. Commit as `docs(tasks): elaborate T-BE-API-CLIENT`.
...
Typed API client used by web and mobile.
...
- Branch: `agent/T-BE-API-CLIENT`
- PR title: `T-BE-API-CLIENT: Typed API client used by web and mobile`
