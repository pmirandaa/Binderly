# T-BE-AUTH — Supabase Auth — Google, Apple, Discord, magic link
...
> **Steps to elaborate:**
>
> 1. Read `PROJECT.md` (especially § 5 (Auth), § 6 (Data Model), § 16 (Freemium)) and any
>    referenced sections.
> 2. Read `rules/02-backend.md` (the stage rules).
...
> 8. Commit as `docs(tasks): elaborate T-BE-AUTH`.
...
**Parallel-safe with:** T-BE-API-CONTRACTS
...
Supabase Auth — Google, Apple, Discord, magic link.
...
- PR title: `T-BE-AUTH: Supabase Auth — Google, Apple, Discord, magic link`
