# T-DP-FLY — Fly.io deployment for Python services
...
> 8. Commit as `docs(tasks): elaborate T-DP-FLY`.
...
**Parallel-safe with:** T-DP-VERCEL, T-DP-SUPABASE-PROD, T-DP-R2-PROD
...
Fly.io deployment for Python services.
...
- Branch: `agent/T-DP-FLY`
- PR title: `T-DP-FLY: Fly.io deployment for Python services`
