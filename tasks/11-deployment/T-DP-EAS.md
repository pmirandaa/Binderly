# T-DP-EAS — EAS Build + Submit for iOS/Android
...
> 8. Commit as `docs(tasks): elaborate T-DP-EAS`.
...
- Branch: `agent/T-DP-EAS`
- PR title: `T-DP-EAS: EAS Build + Submit for iOS/Android`
