...
> 8. Commit as `docs(tasks): elaborate T-SP-PRICING-DISPLAY`.
...
**Parallel-safe with:** T-SP-SET-COMPLETION, T-SP-SMART-DSL, T-SP-UI-TOKENS
...
Pricing display package — FX-aware price formatting (lookup rate of observation date).
