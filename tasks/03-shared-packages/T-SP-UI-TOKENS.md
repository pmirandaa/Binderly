# T-SP-UI-TOKENS — Tamagui design tokens + base components
...
> 8. Commit as `docs(tasks): elaborate T-SP-UI-TOKENS`.
...
**Parallel-safe with:** T-SP-SET-COMPLETION, T-SP-SMART-DSL
...
Tamagui design tokens + base components.
...
- PR title: `T-SP-UI-TOKENS: Tamagui design tokens + base components`
