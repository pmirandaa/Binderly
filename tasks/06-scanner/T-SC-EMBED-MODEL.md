...
> 8. Commit as `docs(tasks): elaborate T-SC-EMBED-MODEL`.
...
**Parallel-safe with:** T-SC-CAMERA, T-SC-DETECT

**Owns paths:**

- `apps/api-python/embeddings/`
- `apps/mobile/src/scanner/embed/`

## Provisional goal

Choose + bundle embedding model (TFLite).
...
- PR title: `T-SC-EMBED-MODEL: Choose + bundle embedding model (TFLite)`
