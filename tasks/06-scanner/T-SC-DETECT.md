# T-SC-DETECT — Card rectangle detection + perspective correction
...
> 8. Commit as `docs(tasks): elaborate T-SC-DETECT`.
...
**Parallel-safe with:** T-SC-EMBED-MODEL
...
Card rectangle detection + perspective correction.
...
- PR title: `T-SC-DETECT: Card rectangle detection + perspective correction`
