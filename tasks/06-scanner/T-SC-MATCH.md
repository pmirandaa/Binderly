# T-SC-MATCH — On-device match pipeline + confidence calibration
...
> 8. Commit as `docs(tasks): elaborate T-SC-MATCH`.
...
- `apps/mobile/src/scanner/match/`

## Provisional goal

On-device match pipeline + confidence calibration.
...
- PR title: `T-SC-MATCH: On-device match pipeline + confidence calibration`
