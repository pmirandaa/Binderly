...
> 8. Commit as `docs(tasks): elaborate T-SC-CAMERA`.
...
- `apps/mobile/src/scanner/camera/`

## Provisional goal

Camera + frame processor infrastructure (vision-camera).
...
- PR title: `T-SC-CAMERA: Camera + frame processor infrastructure (vision-camera)`
