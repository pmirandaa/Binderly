...
> 8. Commit as `docs(tasks): elaborate T-GR-COMMUNITY-FLYWHEEL`.
...
- `apps/mobile/src/grading/community/`
- `apps/api-python/grading/flywheel/`

## Provisional goal

Community submission flywheel (paid users upload graded outcomes).
...
- PR title: `T-GR-COMMUNITY-FLYWHEEL: Community submission flywheel (paid users upload graded outcomes)`
