...
> 8. Commit as `docs(tasks): elaborate T-GR-DATA-PSA`.
...
**Parallel-safe with:** T-GR-DATA-EBAY, T-GR-DATA-AUCTIONS, T-GR-CAPTURE-UX

**Owns paths:**

- `apps/api-python/grading/scrapers/psa/`

## Provisional goal

PSA cert lookup scraper (rate-limited, ToS-aware).
...
- PR title: `T-GR-DATA-PSA: PSA cert lookup scraper (rate-limited, ToS-aware)`
