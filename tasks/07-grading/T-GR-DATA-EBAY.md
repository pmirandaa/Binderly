...
> 8. Commit as `docs(tasks): elaborate T-GR-DATA-EBAY`.
...
**Parallel-safe with:** T-GR-DATA-PSA, T-GR-DATA-AUCTIONS, T-GR-CAPTURE-UX
...
eBay sold listings scraper for graded slabs.
...
- PR title: `T-GR-DATA-EBAY: eBay sold listings scraper for graded slabs`
