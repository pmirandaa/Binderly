...
> 8. Commit as `docs(tasks): elaborate T-GR-CENTERING`.
...
**Parallel-safe with:** T-GR-CORNERS, T-GR-EDGES, T-GR-SURFACE

**Owns paths:**

- `apps/api-python/grading/centering/`
- `apps/mobile/src/grading/centering/`

## Provisional goal

Centering measurement (geometric, deterministic).
...
- PR title: `T-GR-CENTERING: Centering measurement (geometric, deterministic)`
