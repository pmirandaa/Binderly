...
> 8. Commit as `docs(tasks): elaborate T-GR-SURFACE`.
...
**Parallel-safe with:** T-GR-CORNERS, T-GR-EDGES, T-GR-CENTERING

**Owns paths:**

- `apps/api-python/grading/surface/`
- `apps/mobile/src/grading/surface/`

## Provisional goal

Surface subgrade model (training + inference).
...
- PR title: `T-GR-SURFACE: Surface subgrade model (training + inference)`
