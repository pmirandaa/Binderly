...
> 8. Commit as `docs(tasks): elaborate T-PB-REVENUECAT`.
...
**Parallel-safe with:** T-PB-PADDLE
...
RevenueCat SDK integration (mobile).
...
- PR title: `T-PB-REVENUECAT: RevenueCat SDK integration (mobile)`
