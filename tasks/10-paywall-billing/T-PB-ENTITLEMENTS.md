...
> 8. Commit as `docs(tasks): elaborate T-PB-ENTITLEMENTS`.
...
- `infra/supabase/functions/entitlements/`

## Provisional goal

Unified entitlement service (RC as source of truth).
...
- PR title: `T-PB-ENTITLEMENTS: Unified entitlement service (RC as source of truth)`
