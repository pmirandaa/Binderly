# T-PB-PADDLE — Paddle checkout (web; MoR with RC integration)
...
> 8. Commit as `docs(tasks): elaborate T-PB-PADDLE`.
...
**Parallel-safe with:** T-PB-REVENUECAT

**Owns paths:**

- `apps/web/app/billing/`
- `apps/web/app/api/paddle/`

## Provisional goal

Paddle checkout (web; MoR with RC integration).
...
- PR title: `T-PB-PADDLE: Paddle checkout (web; MoR with RC integration)`
