# T-DL-FX-RATES — Daily FX rate ingestion (Frankfurter / ECB) for display-time conversion
...
> 8. Commit as `docs(tasks): elaborate T-DL-FX-RATES`.
...
**Parallel-safe with:** T-DL-PRICING-AGGREGATOR, T-DL-PRICING-EBAY-BROWSE, T-DL-EBAY-LISTING-PARSER, T-DL-SOURCE-TCGDEX-EN, T-DL-SOURCE-PTCGIO, T-DL-SOURCE-BULBAPEDIA, T-DL-SOURCE-TCGDEX-JP
...
Daily FX rate ingestion (Frankfurter / ECB) for display-time conversion.
...
- PR title: `T-DL-FX-RATES: Daily FX rate ingestion (Frankfurter / ECB) for display-time conversion`
