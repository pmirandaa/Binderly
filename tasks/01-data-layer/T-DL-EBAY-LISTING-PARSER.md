...
> 8. Commit as `docs(tasks): elaborate T-DL-EBAY-LISTING-PARSER`.
...
**Parallel-safe with:** T-DL-PRICING-AGGREGATOR, T-DL-PRICING-EBAY-BROWSE, T-DL-SOURCE-TCGDEX-EN, T-DL-SOURCE-PTCGIO, T-DL-SOURCE-BULBAPEDIA, T-DL-SOURCE-TCGDEX-JP

**Owns paths:**

- `data-pipeline/src/parsers/ebay-listing/`

## Provisional goal

eBay listing title parser (slab + grade + condition + card identification).
