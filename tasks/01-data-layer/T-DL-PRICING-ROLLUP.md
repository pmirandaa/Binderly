...
> 8. Commit as `docs(tasks): elaborate T-DL-PRICING-ROLLUP`.
...
- T-DL-PRICING-AGGREGATOR
- T-DL-PRICING-EBAY-BROWSE
...
Daily price observation -> aggregate rollup job (idempotent).
