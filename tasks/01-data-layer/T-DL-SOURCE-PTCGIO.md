...
> 8. Commit as `docs(tasks): elaborate T-DL-SOURCE-PTCGIO`.
...
**Parallel-safe with:** T-DL-SOURCE-TCGDEX-EN, T-DL-SOURCE-BULBAPEDIA, T-DL-SOURCE-TCGDEX-JP

**Owns paths:**

- `data-pipeline/src/adapters/ptcgio/`

## Provisional goal

pokemontcg.io adapter (validation source for English).
