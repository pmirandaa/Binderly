...
> 8. Commit as `docs(tasks): elaborate T-DL-SOURCE-TCGDEX-JP`.
...
**Parallel-safe with:** T-DL-SOURCE-TCGDEX-EN, T-DL-SOURCE-PTCGIO, T-DL-SOURCE-BULBAPEDIA

**Owns paths:**

- `data-pipeline/src/adapters/tcgdex-jp/`
- `data-pipeline/src/adapters/pokemoncard-jp/`

## Provisional goal

TCGdex JP adapter + Pokemon-Card.com fallback (Japanese primary).
...
- PR title: `T-DL-SOURCE-TCGDEX-JP: TCGdex JP adapter + Pokemon-Card.com fallback (Japanese primary)`
