...
> 8. Commit as `docs(tasks): elaborate T-DL-SCHEMA-PRICING`.
...
**Parallel-safe with:** T-DL-SCHEMA-COLLECTIONS, T-DL-SCHEMA-GRADING
...
DB schema for prices and snapshots (scaffolded, gated).
...
- PR title: `T-DL-SCHEMA-PRICING: DB schema for prices and snapshots (scaffolded, gated)`
