...
> 8. Commit as `docs(tasks): elaborate T-DL-SOURCE-TCGDEX-EN`.
...
**Parallel-safe with:** T-DL-SOURCE-PTCGIO, T-DL-SOURCE-BULBAPEDIA, T-DL-SOURCE-TCGDEX-JP

**Owns paths:**

- `data-pipeline/src/adapters/tcgdex-en/`

## Provisional goal

TCGdex EN adapter (primary English source).
