# T-DL-RLS-POLICIES — Supabase RLS policies for all user tables
...
> 8. Commit as `docs(tasks): elaborate T-DL-RLS-POLICIES`.
...
Supabase RLS policies for all user tables.
...
- PR title: `T-DL-RLS-POLICIES: Supabase RLS policies for all user tables`
