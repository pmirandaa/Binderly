...
> 8. Commit as `docs(tasks): elaborate T-M-CUSTOM`.
...
- `apps/mobile/src/screens/collections/`

## Provisional goal

Mobile custom + smart collections (with gating).
...
- PR title: `T-M-CUSTOM: Mobile custom + smart collections (with gating)`
