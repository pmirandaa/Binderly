...
> 8. Commit as `docs(tasks): elaborate T-W-AFFILIATE-LINKS`.
...
- `apps/web/components/buy-cta/`
- `apps/mobile/src/components/buy-cta/`

## Provisional goal

TCGplayer affiliate "Buy" CTAs on card detail (web + mobile).
...
- PR title: `T-W-AFFILIATE-LINKS: TCGplayer affiliate "Buy" CTAs on card detail (web + mobile)`
