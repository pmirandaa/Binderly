...
> 8. Commit as `docs(tasks): elaborate T-W-SHAREABLE-PUBLIC`.
...
Public shareable pages (SSR, OG images).
...
- PR title: `T-W-SHAREABLE-PUBLIC: Public shareable pages (SSR, OG images)`
