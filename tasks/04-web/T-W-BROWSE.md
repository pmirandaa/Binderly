# T-W-BROWSE — Browse + search (sets ordered by release desc, filters, full-text)
...
> 8. Commit as `docs(tasks): elaborate T-W-BROWSE`.
...
Browse + search (sets ordered by release desc, filters, full-text).
...
- PR title: `T-W-BROWSE: Browse + search (sets ordered by release desc, filters, full-text)`
