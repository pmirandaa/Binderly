...
> 8. Commit as `docs(tasks): elaborate T-W-SMART`.
...
Web smart collections (search free, save paid; gated UI).
...
- PR title: `T-W-SMART: Web smart collections (search free, save paid; gated UI)`
