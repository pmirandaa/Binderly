# T-SH-CONFIG-MODEL — Shareable configuration model + management UI (web + mobile)
...
> 8. Commit as `docs(tasks): elaborate T-SH-CONFIG-MODEL`.
...
**Parallel-safe with:** T-SH-OG-IMAGES

**Owns paths:**

- `apps/web/app/settings/shareables/`
- `apps/mobile/src/screens/shareables/`

## Provisional goal

Shareable configuration model + management UI (web + mobile).
...
- PR title: `T-SH-CONFIG-MODEL: Shareable configuration model + management UI (web + mobile)`
