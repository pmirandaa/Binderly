# T-SC-UX — Continuous scan UX — auto-add, disambiguation, undo, session footer
...
> **Steps to elaborate:**
>
> 1. Read `PROJECT.md` (especially § 11 (Scanner Pipeline)) and any
>    referenced sections.
> 2. Read `rules/06-scanner.md` (the stage rules).
...
> 8. Commit as `docs(tasks): elaborate T-SC-UX`.
...
- `apps/mobile/src/scanner/ui/`
- `apps/mobile/src/screens/scan/`

## Provisional goal

Continuous scan UX — auto-add, disambiguation, undo, session footer.
...
- PR title: `T-SC-UX: Continuous scan UX — auto-add, disambiguation, undo, session footer`
