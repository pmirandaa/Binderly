...
> 8. Commit as `docs(tasks): elaborate T-W-CUSTOM`.
...
Web manual custom collections (3-cap on free).
...
- PR title: `T-W-CUSTOM: Web manual custom collections (3-cap on free)`
