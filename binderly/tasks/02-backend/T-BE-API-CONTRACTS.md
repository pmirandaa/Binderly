...
> 8. Commit as `docs(tasks): elaborate T-BE-API-CONTRACTS`.
...
Shared API contracts package (zod + types).
...
- Branch: `agent/T-BE-API-CONTRACTS`
- PR title: `T-BE-API-CONTRACTS: Shared API contracts package (zod + types)`
