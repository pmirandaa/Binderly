...
> 8. Commit as `docs(tasks): elaborate T-M-BROWSE`.
...
**Parallel-safe with:** T-M-AUTH

**Owns paths:**

- `apps/mobile/src/screens/browse/`
- `apps/mobile/src/screens/set/`
- `apps/mobile/src/screens/card/`

## Provisional goal

Mobile browse, set, card detail.
...
- PR title: `T-M-BROWSE: Mobile browse, set, card detail`
