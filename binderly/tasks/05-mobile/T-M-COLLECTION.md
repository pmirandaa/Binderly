...
> 8. Commit as `docs(tasks): elaborate T-M-COLLECTION`.
...
**Parallel-safe with:** T-M-CUSTOM

**Owns paths:**

- `apps/mobile/src/screens/collection/`

## Provisional goal

Mobile collection home + per-set progress.
...
- PR title: `T-M-COLLECTION: Mobile collection home + per-set progress`
