# T-M-SHELL — Expo app shell — navigation, tabs, theme
...
> 8. Commit as `docs(tasks): elaborate T-M-SHELL`.
...
Expo app shell — navigation, tabs, theme.
...
- PR title: `T-M-SHELL: Expo app shell — navigation, tabs, theme`
