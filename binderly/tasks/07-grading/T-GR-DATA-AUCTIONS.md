...
> 8. Commit as `docs(tasks): elaborate T-GR-DATA-AUCTIONS`.
...
**Parallel-safe with:** T-GR-DATA-PSA, T-GR-DATA-EBAY, T-GR-CAPTURE-UX

**Owns paths:**

- `apps/api-python/grading/scrapers/auctions/`

## Provisional goal

PWCC + Goldin auction archive scrapers.
...
- PR title: `T-GR-DATA-AUCTIONS: PWCC + Goldin auction archive scrapers`
