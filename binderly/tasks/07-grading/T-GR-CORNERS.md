...
> 8. Commit as `docs(tasks): elaborate T-GR-CORNERS`.
...
**Parallel-safe with:** T-GR-EDGES, T-GR-SURFACE, T-GR-CENTERING

**Owns paths:**

- `apps/api-python/grading/corners/`
- `apps/mobile/src/grading/corners/`

## Provisional goal

Corners subgrade model (training + inference).
...
- PR title: `T-GR-CORNERS: Corners subgrade model (training + inference)`
