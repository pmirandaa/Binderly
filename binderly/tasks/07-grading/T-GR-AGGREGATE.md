...
> 8. Commit as `docs(tasks): elaborate T-GR-AGGREGATE`.
...
- `apps/api-python/grading/aggregate/`
- `apps/mobile/src/grading/aggregate/`

## Provisional goal

Subgrade aggregation + calibration to PSA + confidence band.
...
- PR title: `T-GR-AGGREGATE: Subgrade aggregation + calibration to PSA + confidence band`
