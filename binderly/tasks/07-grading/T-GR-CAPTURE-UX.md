...
> 8. Commit as `docs(tasks): elaborate T-GR-CAPTURE-UX`.
...
**Parallel-safe with:** T-GR-CENTERING, T-GR-DATA-PSA, T-GR-DATA-EBAY, T-GR-DATA-AUCTIONS

**Owns paths:**

- `apps/mobile/src/grading/capture/`

## Provisional goal

Multi-shot guided capture flow.
...
- PR title: `T-GR-CAPTURE-UX: Multi-shot guided capture flow`
