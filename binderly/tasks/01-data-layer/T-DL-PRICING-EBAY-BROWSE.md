...
> 8. Commit as `docs(tasks): elaborate T-DL-PRICING-EBAY-BROWSE`.
...
- T-DL-SCHEMA-PRICING
- T-DL-EBAY-LISTING-PARSER

**Parallel-safe with:** T-DL-PRICING-AGGREGATOR

**Owns paths:**

- `data-pipeline/src/adapters/pricing-ebay-browse/`

## Provisional goal

eBay Browse API adapter (Layer 2 — active listings, free, no approval).
...
- PR title: `T-DL-PRICING-EBAY-BROWSE: eBay Browse API adapter (Layer 2 — active listings, free, no approval)`
