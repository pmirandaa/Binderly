...
> 8. Commit as `docs(tasks): elaborate T-DL-PRICING-AGGREGATOR`.
...
**Parallel-safe with:** T-DL-PRICING-EBAY-BROWSE, T-DL-EBAY-LISTING-PARSER, T-DL-SOURCE-TCGDEX-EN, T-DL-SOURCE-PTCGIO, T-DL-SOURCE-BULBAPEDIA, T-DL-SOURCE-TCGDEX-JP

**Owns paths:**

- `data-pipeline/src/adapters/pricing-aggregator/`

## Provisional goal

Pricing aggregator adapter (Layer 1 — eBay sold + Cardmarket via paid API).
...
- PR title: `T-DL-PRICING-AGGREGATOR: Pricing aggregator adapter (Layer 1 — eBay sold + Cardmarket via paid API)`
