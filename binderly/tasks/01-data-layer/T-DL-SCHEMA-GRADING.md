# T-DL-SCHEMA-GRADING — DB schema for grading_submissions and training data
...
> 8. Commit as `docs(tasks): elaborate T-DL-SCHEMA-GRADING`.
...
**Parallel-safe with:** T-DL-SCHEMA-CARDS, T-DL-SCHEMA-COLLECTIONS, T-DL-SCHEMA-PRICING
...
DB schema for grading_submissions and training data.
...
- PR title: `T-DL-SCHEMA-GRADING: DB schema for grading_submissions and training data`
