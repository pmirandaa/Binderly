...
> 8. Commit as `docs(tasks): elaborate T-DL-SOURCE-BULBAPEDIA`.
...
**Parallel-safe with:** T-DL-SOURCE-TCGDEX-EN, T-DL-SOURCE-PTCGIO, T-DL-SOURCE-TCGDEX-JP
...
Bulbapedia adapter (validation/filler).
