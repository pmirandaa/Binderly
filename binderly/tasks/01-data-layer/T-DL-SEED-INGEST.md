# T-DL-SEED-INGEST — Initial bulk ingest job — runs adapters → resolver → DB → R2
...
> 8. Commit as `docs(tasks): elaborate T-DL-SEED-INGEST`.
...
- T-DL-SOURCE-TCGDEX-EN
- T-DL-SOURCE-PTCGIO
- T-DL-SOURCE-BULBAPEDIA
- T-DL-SOURCE-TCGDEX-JP
...
Initial bulk ingest job — runs adapters → resolver → DB → R2.
...
- PR title: `T-DL-SEED-INGEST: Initial bulk ingest job — runs adapters → resolver → DB → R2`
