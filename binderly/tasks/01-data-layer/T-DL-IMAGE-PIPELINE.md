...
> 8. Commit as `docs(tasks): elaborate T-DL-IMAGE-PIPELINE`.
...
**Parallel-safe with:** T-DL-SOURCE-TCGDEX-EN, T-DL-SOURCE-PTCGIO, T-DL-SOURCE-BULBAPEDIA, T-DL-SOURCE-TCGDEX-JP

**Owns paths:**

- `data-pipeline/src/images/`
- `infra/r2/`

## Provisional goal

Image ingestion → R2 with WebP variants and provenance metadata.
...
- PR title: `T-DL-IMAGE-PIPELINE: Image ingestion → R2 with WebP variants and provenance metadata`
