...
//      `PriceObservationRepo` (Drizzle in production; in-memory in
//      tests).
 ...
 * inject `InMemoryPriceObservationRepo`; production wires a
...
/**
 * In-memory `PriceObservationRepo`. Keys on the canonical UNIQUE
