// Test fixtures for the mobile shareables settings screen.
// Functionally a sibling to the web fixtures
// (`apps/web/app/settings/shareables/fixtures.ts`); kept locally
// so the mobile vitest config resolves it under its own glob
