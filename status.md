# Build status — **Iter 30 closed.** **Scanner stage CLOSED (6/6).** Stage 07 grading **8/10** (T-GR-EDGES + T-GR-SURFACE merged). **Stage 09 offline-sync 2/3** (T-OF-QUEUE merged). Q-016 resolved (T-OF-QUEUE; set_logo_url denormalised); Q-017 raised + closed in same iter (resolved by #FU-44, ml_common subgrade-key generalisation).
