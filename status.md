...
**Stage 07 grading:** **2 / 10 merged** (T-GR-CAPTURE-UX #79 — iter 26; T-GR-CENTERING #81 — iter 27). Capture flow + centering measurement (Python authoritative + TS contract) + session-routing seam shipped.
