...
- **#FU-41 — Full catalog mirror in `printing_lite`** (T-OF-LOCAL-DB): currently populated only as upsert side-effect for user-interacted printings; full background sync is T-OF-QUEUE's job.
...
- T-GR-DATA-AUCTIONS — `50304f4` (Stage 07 grading 5/10; PWCC + Goldin scrapers; migration 0022; 116 pytest tests; raised #FU-37–#FU-39) — iter 28
