# Build status — Iter 30 in progress. **Scanner stage CLOSED (6/6).** Stage 07 grading **7/10** (T-GR-EDGES merged; SURFACE still in progress). **Stage 09 offline-sync (1/3)**. Q-44 raised (ml_common generalisation).
...
**Stage 07 grading:** **7 / 10 merged** (T-GR-CAPTURE-UX #79 — iter 26; T-GR-CENTERING #81 — iter 27; T-GR-DATA-PSA #82, T-GR-DATA-EBAY #83, T-GR-DATA-AUCTIONS #84 — iter 28; T-GR-CORNERS #86 — iter 29; T-GR-EDGES #87 — iter 30). Capture + centering + 3 data scrapers + corners + edges sub-grade models + `ml_common/` shared training infra shipped. T-GR-SURFACE still in progress.
...
- T-GR-DATA-EBAY — `8160ea3` (Stage 07 grading 4/10; eBay scraper; migration 0021; 49 pytest tests) — iter 28
